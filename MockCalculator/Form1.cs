...
/*
        ...
        {
            string eq = quadEquation.Text;
            if (eq == "")
            {
                SolveQuadEq.Text = "No Input Given.";
            }
            else
            {
                int first = 0;
                ...
                if (discriminant < 0)
                {
                    MessageBox.Show("No Root Exists.");
                }
                else
                {
                    ...
                    rootsDisplay.Text = "x = " + currRoots.Root1.ToString() + ", x = " + currRoots.Root2.ToString();
